...
int32_t accept_line(tib::editor_context& ctx, int32_t key, const char* name);

int32_t begin_of_line(tib::editor_context& ctx, int32_t key, const char* name);
int32_t end_of_line(tib::editor_context& ctx, int32_t key, const char* name);
int32_t backward_char(tib::editor_context& ctx, int32_t key, const char* name);
int32_t forward_char(tib::editor_context& ctx, int32_t key, const char* name);
...
int32_t undo(tib::editor_context& ctx, int32_t key, const char* name);
